var __tea_iife_export__ = function(exports) {
    ...
    function __rest(e, t) {
        ...
        if (null != e && "function" == typeof Object.getOwnPropertySymbols) {
            var r = 0;
            for (n = Object.getOwnPropertySymbols(e); r < n.length; r++) t.indexOf(n[r]) < 0 && (i[n[r]] = e[n[r]])
        }
        return i
    }
    ...
    function xhr(e, t, i, n, r, o, s, a) {
        try {
            var c = new XMLHttpRequest,
                u = a || "POST";
            c.open(u, "" + e, !0), c.setRequestHeader("Content-Type", "application/json; charset=utf-8"), r && c.setRequestHeader("X-MCS-AppKey", "" + r), s && (c.withCredentials = !0), c.onload = function() {
                if (i) {
                    var e = null;
                    if (c.responseText) {
                        try {
    ...
    var isSupportBeacon = function() {
        ...
        encodePayload = function(e) {
            var t = "";
            for (var i in e) e.hasOwnProperty(i) && void 0 !== e[i] && (t += "&" + i + "=" + encodeURIComponent(JSON.stringify(e[i])));
        ...
        sendByImg = function(e, t, i, n) {
            try {
                ...
                var s = e.split(o)[0];
                if (!s) return void n(e, t, ERROR.NO_URL);
        ...
        request = function(e, t, i, n, r, o, s, a, c, u) {
            var h = window.navigator.userAgent,
                ...
                l = !!n;
            if (!l && d) sendByImg(e, i, r, o);
            else if (!l && a) return isSupportBeacon() ? (u ? u() : NOOP(), void(window.navigator.sendBeacon(e, JSON.stringify(i)) ? r() : o(e, i, ERROR.BEACON_FALSE))) : void sendByImg(e, i, r, o);
            s && delete i.app_key, xhr(e, i, r, o, n, t, c)
        };
    ...
    var decodeUrl = function(e) {
        ...
        UTM = function(e, t, i, n) {
            ...
            try {
                var l = !1;
                for (var f in h) h[f] && (-1 !== u.indexOf(f) ? (c.hasOwnProperty("tracer_data") || (c.tracer_data = {}), c.tracer_data[f] = h[f]) : c[f] = h[f], l = !0);
                if (l) o.setItem(a, "1"), r.setCookie(s, JSON.stringify(c), d, i);
                else {
                    var p = r.getCookie(s, i);
                    p && (c = JSON.parse(p), r.setCookie(s, p, d, i))
                }
                o.getItem(a) && (c.hasOwnProperty("tracer_data") || (c.tracer_data = {}), c.tracer_data.$utm_from_url = 1)
            } catch (e) {
                return h
            }
            return c
        ...
        client = function(e, t, i) {
            ...
            switch (/Windows/.test(g) && (m = I(/Windows (.*)/, g), g = "windows"), g) {
                case "Mac OS X":
                    b = c, m = (w = RegExp("(?:^|[^A-Z0-9-_]|[^A-Z0-9-]_|sprd-)(?:" + "Mac[ +]OS[ +]X(?:[ /](?:Version )?(\\d+(?:[_\\.]\\d+)+))?" + ")", "i").exec(b)) ? w.slice(1)[0] : "", g = "mac";
                    break;
                case "Android":
                    m = function(e) {
                        var t = I(/Android ([\.\_\d]+)/, e);
                        return t || (t = I(/Android\/([\.\_\d]+)/, e)), t
                    }(c), g = "android";
                    break;
                case "iOS":
                    m = (m = /OS (\d+)_(\d+)_?(\d+)?/.exec(a)) ? m[1] + "." + m[2] + "." + (0 | m[3]) : "", g = "ios"
            }
            var O = UTM(e, _, t, i);
            return {
                browser: v,
        ...
        Token = function() {
            function e(e, t, i, n) {
                this.tokenReadyInit = !1, this.enable_ttwebid = !1, this.enableCustomWebid = !1, this.config = e, this.cfg = t, this.storage = new Storage(!1), this.appInfo = e.app_key || e.app_id, this.isNoWebid = e.disable_webid, this.enable_ttwebid = e.enable_ttwebid || !1, this.isNoSsid = e.disable_webid || e.disable_ssid, this.enableCustomWebid = e.enable_custom_webid, this.domain = e.channel_domain || decodeUrl(LOG_URL[e.channel]), this.tokenReady = !1, this.checkExp = e.checkExp || !1, this.enableCookie = e.cross_subdomain || !1, this.expiresTime = e.cookie_expire || COOKIE_EXPIRE, this.fetchUrl = "" + this.domain + WEBID_URL, this.uuidQueue = [], this.sendQueue = [], this.hook = i, this.cookieDomain = e.cookie_domain || "", this.session = n
            }
            return e.prototype._getToken = function() {
                var e = this;
                try {
                    if (this.tokensKey = CACHEKEY(this.appInfo, !0), this.cookieKey = COOKIEKEY(this.appInfo), this.enableCustomWebid) return void this.hook.on("custom-webid", function() {
                        e.tokenReady = !0, e.tokenReadyInit = !0, e.hook.emit("token-ready")
                    });
                    ...
                    if (this.enable_ttwebid)
                        if (t) {
                            ...
                            this.storage.setItem(this.tokensKey, i), this._setTtWid(t, !1)
                        ...
                        if (n) {
                            ...
                            this.storage.setCookie(this.cookieKey, encodeURIComponent(JSON.stringify(t)), this.expiresTime, this.cookieDomain), this._checkLocal(t)
                        }
                    } else {
                        if (!t) return void this._requestWebId();
                        this._checkLocal(t)
                ...
                if (-1 !== window.navigator.userAgent.indexOf("miniProgram")) {
                    ...
                    return !(!e || !e.Web_ID) && (this._setTokenId("" + e.Web_ID, "", "", !0), !0)
                }
                return !1
                ...
                this.cfg.envInfo.user.ssid = i, this.cfg.envInfo.user.web_id = e, this.cfg.envInfo.user.user_unique_id = t, this.tokenReady = !0, this.tokenReadyInit = !0
                ...
                var i = this;
                this.isGetWebId = !0, request(e, 5e3, {
                ...
                if (!t) {
                    var i = {
                        ...
                        n = e.user_unique_id || "";
                    this.cfg.envInfo.user.user_unique_id = this.cfg.envInfo.user.user_unique_id || n, this.storage.setCookie(this.cookieKey, encodeURIComponent(JSON.stringify(i)), 108e5, this.cookieDomain)
                }
                this.tokenReady = !0, this.tokenReadyInit = !0, this.hook.emit("token-ready")
                ...
                this.enableCookie && this.storage.setCookie(this.cookieKey, encodeURIComponent(JSON.stringify(o)), this.expiresTime, this.cookieDomain), this.storage.setItem(this.tokensKey, o), this.cfg.envInfo.user.ssid = i || void 0, this.cfg.envInfo.user.web_id = r, this.cfg.envInfo.user.user_unique_id = t || r, this.uuid = t || r, this.web_id = r, this.ssid = i, n && (this.tokenReady = !0, this.tokenReadyInit = !0, this.hook.emit("token-ready"))
            }, e.prototype._setWebid = function(e) {
                if (!this.enable_ttwebid) {
                    var t = this.storage.getItem(this.tokensKey);
                    t && t.web_id ? t.web_id !== e && (t.user_unique_id = t.web_id === t.user_unique_id ? e : t.user_unique_id, t.web_id = e) : ((t = {}).web_id = e, t.user_unique_id = e), t.timestamp = Date.now(), this.storage.setItem(this.tokensKey, t), this.cfg.envInfo.user.user_unique_id && this.cfg.envInfo.user.user_unique_id !== this.cfg.envInfo.user.web_id || (this.cfg.envInfo.user.user_unique_id = e, this.hook.emit("uuid-change"), this.enableCustomWebid ? this.hook.emit("token-change", {
                        type: "uuid",
                        info: t
                    }) : this._getSsid(e)), e !== this.cfg.envInfo.user.web_id && (this.cfg.envInfo.user.web_id = e, this.hook.emit("token-change", {
                        type: "webid",
                        info: t
                    }))
                }
                ...
                if (e && -1 === ["0", "Null", "None", "", "undefined"].indexOf(e)) {
                    var i = String(e);
                    this.cfg.envInfo.user.user_unique_id !== i && (t && t.user_unique_id ? t.user_unique_id !== i && (t.user_unique_id = i) : (t = {}).user_unique_id = i, t.timestamp = Date.now(), this.cfg.envInfo.user.user_unique_id = i, this.hook.emit("uuid-change"), this.session._resetSessionId(), this.hook.emit("uuid-change"), this.enableCustomWebid ? this.hook.emit("token-change", {
                        type: "uuid",
                        _token: t
                    }) : this._getSsid(i))
                } else console.log("user_unique_id is useless, please check")
            }, e.prototype._clearUuid = function(e) {
                this.enable_ttwebid || e && e.web_id && (this.cfg.envInfo.user.user_unique_id = e.web_id || void 0, e.user_unique_id = e.web_id || void 0, e.timestamp = Date.now(), this.storage.setItem(this.tokensKey, e))
            }, e.prototype._getSsid = function(e) {
                e && -1 === ["0", "Null", "None", "", "undefined"].indexOf(e) && this.uuid !== e && (this.uuidQueue.push(e), this.uuid = e, -1 === this.uuidQueue.indexOf(e) && this.uuidQueue.push(e), this.isNoSsid || this.isGetWebId || (this.tokenReady = !1, this._requestSsId(e), this.sendQueue.push(e)), this.session._resetSessionId())
                ...
                if (!this.sendQueue.length) {
                    ...
                    request(i, 5e3, {
                        ...
                        t.sendQueue = [], t.uuidQueue.length && t.uuidQueue.splice(t.uuidQueue.indexOf(e), 1), i && 0 === i.e ? (t.tokenReadyInit && t.hook.emit("token-change", {
                            type: "uuid",
                            info: {
                                webid: t.web_id,
                                user_unique_id: e,
                        ...
                        }), t._setTokenId(t.web_id, e, i.ssid, 0 === t.uuidQueue.length), t.uuidQueue.length && t._requestSsId(t.uuidQueue[0])) : (t.tokenReady = !0, t.hook.emit("token-ready"), console.warn("[]appid: " + t.config.app_id + ", get ssid error"))
                    }, function() {
        ...
        EventManager = function() {
            function e(e, t, i, n, r, o, s, a) {
                this.collect = e, this.cfg = i, this.config = t, this._token = n, this.appInfo = t.app_id || t.app_key, this.debugMode = !!t.log, this.evtDataKey = CACHEKEY(this.appInfo, !1);
                var c = t.channel_domain || decodeUrl(LOG_URL[t.channel]),
                    u = t.enable_custom_webid ? NEW_REPORT_URL : REPORT_URL;
                if (this.reportUrl = t.report_url ? t.report_url : "" + c + u, this.storage = new Storage(!0), this.EventStorage = new Storage(!1), this.maxStorage = t.max_storage_num || -1, this.maxReport = t.max_report || 10, this.reportTime = t.reportTime || 30, this.timeout = t.timeout || 1e5, this.closeStorage = !0, this.plugin = r, this.session = o, this.hook = s, this.filter = t.filter, this.match = a, this.plugin) {
            ...
            return e.prototype.addListener = function() {
                ...
                if (void 0 === e && (e = []), this._token.isTokenReady() && this.isReady) {
                        ...
                        events: e.map(function(e) {
                            ...
                            try {
                                if (e.event && "applog_trace" !== e.event) {
                                    ...
                                    if (o && o.uuid && i.user.user_unique_id !== o.uuid && (r = !1), r && t.plugin && t.plugin.ab && t.plugin.ab.versions && t.plugin.ab.extVersions) {
                                        var s = [];
                                        return s = t.config.enable_multilink || -1 !== window.location.href.indexOf("multilink=true") ? t.plugin.ab.mulilinkVersions.concat(t.plugin.ab.extVersions) : t.plugin.ab.versions.concat(t.plugin.ab.extVersions), __assign({}, e, {
                ...
                if (!this.config.disable_track_event) {
                    ...
                    n = splitArrayByFilter(e, function(e) {
                    ...
                    }, this.maxReport), !this.closeStorage && this.plugin.maxStorage && this.plugin.maxStorage(n, this.maxStorage, this.evtDataKey, this.storage), n.forEach(function(e) {
                        var n = webid(),
                            r = JSON.parse(JSON.stringify(e));
                        try {
                            i.filter && (r = i.filter(r)), i.collect.eventFilter && (r = i.collect.eventFilter(r))
                        } catch (e) {}
                        var o = r || e;
                        if (!i.closeStorage && !o[0].__disable_storage__) {
                            ...
                            a[n] = s, i.EventStorage.setItem(i.evtDataKey, a)
                        }
                        i._send(n, o, t), i.match && setTimeout(function() {
                ...
                this.plugin && this.plugin.et_test && this.plugin.et_test.send(t), request(this.reportUrl, this.timeout, t, this.config.app_key, function(t, i) {
                    ...
                    r(), n.cfg.get("reportErrorCallback")(e, t), n.collect && n.collect.tracer && 1 !== n.cfg.staging && n.collect.tracer.addErrorCount(e, "f_net", t), n.plugin && n.plugin.monitor && n.plugin.monitor.sdkError(n.config.app_key, n.reportUrl, e, t)
                }, !1, i, this.config.enable_ttwebid, r), this.plugin && this.plugin.monitor && this.plugin.monitor.sdkOnload(this.config.app_key, this.reportUrl, t)
                ...
                try {
                    ...
                    if (i.length > 0) {
                        setTimeout(function n() {
                            for (var r = [], o = 0; o < e.maxReport; o++) i.length > 0 && r.push(i.shift());
        ...
        ConfigManager = function() {
            function e(e, t, i) {
                ...
                this.configKey = CONFIGKEY("" + e), this.sessionStorage = new Storage(!1, "session"), this.localStorage = new Storage(!1, "local"), i && (this.storage = 1 === i ? this.sessionStorage : this.localStorage), this.envInfo = {
                    user: {
                ...
                }, this.isLast = !1, this.setCustom(n), this.evtParams = {}, this.reportErrorCallback = function() {}
            }
            return e.prototype.setCustom = function(e) {
                if (e && e.latest_data && e.latest_data.isLast)
                    for (var t in delete e.latest_data.isLast, this.isLast = !0, e.latest_data) this.envInfo.header.custom[t] = e.latest_data[t]
                ...
                if (null == t && (this.delete(e), t = void 0), "evtParams" === e || "_staging_flag" === e) {
                    ...
                    if ("os_version" === e && (e = "" + t), "traffic_type" === e && this.isLast && (this.envInfo.header.custom.$latest_traffic_source_type = t), "web_id" === e) {
                        if (!t) return;
        ...
        Hook = function() {
            ...
            return e.prototype.on = function(e, t) {
                ...
                if (e && this._hooks[e] && this._hooks[e].length)
                    if (t) {
                        var i = this._hooks[e].indexOf(t); - 1 !== i && this._hooks[e].splice(i, 1)
                    } else this._hooks[e] = []
        ...
        Session = function() {
            function e(e, t) {
                this.storage = new Storage(!1, "session"), this.sessionKey = SESSIONKEY(e), this.expireTime = t.expireTime || 18e5, this.disableSession = t.disable_session, this.disableSession || this._setSessionId()
            }
        ...
        Tracer = function() {
            function e(e, t, i, n) {
                this.enable_tracer = !1, this.count = {
                    pv: 0,
                    sdk: 0,
                    autotrack: 0,
                    log: 0
                ...
                }, this.collect = e, this.ready = !(!t.app_id || !t.enable_tracer || t.disable_track_event), this.appid = t.app_id, this.process = i, this.event = n;
                var r = t.channel_domain || decodeUrl(LOG_URL[t.channel]);
                this.reportUrl = t.report_url ? t.report_url : "" + r + REPORT_URL, this.listener()
            }
            return e.prototype.addCount = function(e) {
                try {
                    ...
                    if (this.count[e]++, this.count[e] >= this.limit[e]) {
                        var t = [];
                        for (var i in t = __spread(t, this.processTracer(this.count[e], e, "net")), this.errorInfo[e]) this.errorInfo[i] && (t = __spread(t, this.processTracer(this.errorInfo[e][i], e, i)));
                ...
                try {
                    ...
                    n && window.navigator.sendBeacon ? window.navigator.sendBeacon(this.reportUrl, JSON.stringify(r)) : request(this.reportUrl, 3e5, r, ""), t ? this.clearCount(i) : this.clearCount()
                } catch (e) {}
                ...
                try {
                    ...
                    var r = [];
                    if (r.push(this.process("applog_trace", n, !0)), r && r.length) return delete r[0].is_bav, r
                } catch (e) {}
                ...
                if (this.ready) try {
                    ...
                    for (var t in this.count)
                        if (this.count[t]) {
                            ...
                            for (var n in e = __spread(e, this.processTracer(this.count[t], t, "net")), i) i[n] && (e = __spread(e, this.processTracer(i[n], t, n)))
                        }
    ...
    var Ruote = function() {
            function e(e) {
                this.autotrack = !1, this.spa = !1, this.cache = {}, (e.spa || e.autotrack) && (this.config = e, this.autotrack = !!e.autotrack, this.spa = e.spa, this.fncArray = new Map, this.setLocation(), this.hack(), this.setKey(), this.listener())
            }
            return e.prototype.setKey = function() {
                this.storage = new Storage(!1), this.cache_key = "__tea_cache_refer_" + this.config.app_id, this.cache = {
                ...
                history.pushState = function(i) {
                    ...
                    return e.lastLocation = stringify(location.href, n[1]), e.cache.refer_key = e.lastLocation, e.storage.setItem(e.cache_key, e.cache), e.sendPv(s, "pushState"), o
                };
                ...
                history.replaceState = function(t) {
                    ...
                    var o = i.call.apply(i, __spread([history, t], n)),
                        s = e.getPopStateChangeEventData();
                    return e.lastLocation = stringify(location.href, n[1]), e.cache.refer_key = e.lastLocation, e.storage.setItem(e.cache_key, e.cache), e.sendPv(s), o
                }
                ...
                var e = "",
                    ...
                    i = !1;
                return e = document.referrer ? document.referrer : t.refer_key || "", i = !this.storage.getItem("__tea_cache_first_" + this.config.app_id), {
                    is_html: 1,
                    url: location.href,
                    referrer: e,
        ...
        hashCode = function(e) {
            for (var t = 0, i = 0, n = (e += "").length, r = 0; r < n; r++)((t = 31 * t + e.charCodeAt(i++)) > 0x7fffffffffff || t < -0x800000000000) && (t &= 0xffffffffffff);
    ...
    var PageAlive = function() {
            function e(e, t) {
                ...
                this._sendEvent = function(e) {
                    ...
                    }), "sdk"), i.sessionStartTime = getCurrentTime())
                }, this._setUpTimer = function() {
                    return i.timerHandler && clearInterval(i.timerHandler), setInterval(function() {
                        getCurrentTime() - i.sessionStartTime > i.options.aliveDTime && i._sendEvent(!0)
                    }, 1e3)
                }, this._visibilitychange = function() {
                    "hidden" === document.visibilityState ? i.timerHandler && (clearInterval(i.timerHandler), i._sendEvent()) : "visible" === document.visibilityState && (i.sessionStartTime = getCurrentTime(), i.timerHandler = i._setUpTimer())
                ...
                }, this.pageStartTime = getPageStartTime(), this.sessionStartTime = this.pageStartTime, this.timerHandler = null, this.disableCallback = function() {}
            }
            return e.prototype.enable = function(e, t, i) {
                ...
                var e = this;
                return this.timerHandler = this._setUpTimer(), document.addEventListener("visibilitychange", this._visibilitychange), beforePageUnload(this._beforeunload),
                    function() {
        ...
        PageClose = function() {
            function e(e, t) {
                var i = this;
                this._visibilitychange = function() {
                    "hidden" === document.visibilityState ? i.activeEndTime = getCurrentTime() : "visible" === document.visibilityState && (i.activeEndTime && (i.totalTime += i.activeEndTime - i.activeStartTime, i.activeTimes += 1), i.activeEndTime = void 0, i.activeStartTime = getCurrentTime())
                }, this._beforeunload = function() {
                    if (i.totalTime += (i.activeEndTime || getCurrentTime()) - i.activeStartTime, i.config.autotrack) {
                        try {
                ...
                }, this.maxDuration = t.maxDuration || 864e5, this.disableCallback = function() {}, this.pageStartTime = getPageStartTime(), this._resetData()
            }
            return e.prototype.enable = function(e, t, i) {
                ...
                this.activeStartTime = void 0 === this.activeStartTime ? getPageStartTime() : Date.now(), this.activeEndTime = void 0, this.activeTimes = 1, this.totalTime = 0
                ...
                var e = this;
                return document.addEventListener("visibilitychange", this._visibilitychange), beforePageUnload(this._beforeunload),
                    function() {
                        e._beforeunload(), document.removeEventListener("visibilitychange", e._visibilitychange), window.removeEventListener("beforeunload", e._beforeunload), window.removeEventListener("pagehide", e._beforeunload)
                    }
            }, e
        ...
        StayDuration = function() {
            function e(e, t) {
                this.pageAlive = new PageAlive(e, t), this.pageClose = new PageClose(e, t), this.title = document.title || location.pathname, this.url = location.href, this.url_path = location.pathname, this._enable(this.url_path, this.title, this.url)
            }
    ...
    function openOverlayer() {
        if (!document.getElementById(STYLE_ID)) {
            ...
            i.id = STYLE_ID, i.type = "text/css", i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(document.createTextNode(e)), t.appendChild(i)
        }
    }
    ...
    function init(e, t) {
        var i = __assign({}, e);
        i.filter && delete i.filter, "object" == typeof i.autotrack && i.autotrack.collect_url && delete i.autotrack.collect_url, (window.opener || window.parent).postMessage({
            type: "tea:sdk:info",
            config: e,
            version: t
    ...
    function loadEditorScript(e) {
        ...
        isLoaded || (isLoaded = !0, loadScript(i, function() {
    ...
    function readyToLoadEditor(e, t, i, n) {
        ...
        receiveMsg("tea:openVisualABEditor", function(n) {
            ...
            if (r) {
                var s = r.lang;
                if (r.appId !== t) return dispatchMsg(n, "appIdError"), void console.error("abtest appid is not belong the page appid please check");
                var a = r.version;
                if (a) VISUAL_URL = o ? "" + o + (a ? "." + a : ".1.0.1") + ".js?query=" + Date.now() : decodeUrl(VISUAL_URL_ASC) + "?query=" + Date.now();
                else VISUAL_URL = decodeUrl(VISUAL_URL_ASC) + "?query=" + Date.now();
                window.TEAVisualEditor.lang = s, i && (window.TEAVisualEditor.__ab_domin = i), loadEditorScript({
                    event: n,
            ...
            window.TEAVisualEditor.appId = t, receiveMsg("tea:openTesterEventInspector", function(t) {
                ...
                if (i) {
                    var n = i.referrer,
                        r = i.lang,
                        o = i.appId;
                    window.TEAVisualEditor.__editor_ajax_domain = n || "", window.TEAVisualEditor.__ab_appId = o || "", window.TEAVisualEditor.lang = r || "", loadEditorScript({
                        event: t,
    ...
    function(e) {
        e[e.Ing = 0] = "Ing", e[e.Complete = 1] = "Complete"
    ...
    var AB = function() {
            function e(e, t, i) {
                var n = this;
                this.appId = 0, this.user = {}, this.header = {}, this.domain = "", this.protocal = location.protocol, this.fetchStatus = FetchStatus.No, this.refreshFetchStatus = RefreshFetchStatus.Complete, this.callbacks = [], this.data = null, this.versions = [], this.extVersions = [], this.mulilinkVersions = [], this.collector = e, this.initConfig = i;
                var r = this.collector._initConfig,
                    ...
                    l = r.ab_timeout;
                if (this.appId = o, this.timeout = l || 3e3, this.domain = u || decodeUrl(DOMAINS[s || "cn"]), this.domain) {
                    this.needOverlay = a || d || !1, this.enable_ab_visual = d, this.enable_multilink = a, this.closeTime = c || 500, this.Hook = t;
                    var f = h || decodeUrl(LOG_URL[s]);
                    this.reportUrl = "" + f + REPORT_URL, this.editCheck(), d && (readyToLoadEditor(e, this.appId, u || "", i), "visual-editor" === this.editMode) ? this.collector.destroy() : (a && loadMuiltlink(e, this.appId, u || "", i), this.Hook.on("uuid-change", function() {
            ...
            return e.prototype.editCheck = function() {
                ...
                if (e) {
                    var t = e.scenario,
                        i = e.href;
                    t ? "heatmap" === t ? (console.log("heatmap mode"), this.editMode = "heatmap") : "visual-editor" === t && (console.log("visual mode"), this.editMode = "visual-editor") : !i || -1 === i.indexOf("datatester") && -1 === i.indexOf("visual-editor") || (console.log("visual mode"), this.editMode = "visual-editor")
                }
            }, e.prototype.checkFromUrl = function() {
                var e = parseUrlQuery(window.location.href);
                return e && e.vid ? e.vid : ""
            }, e.prototype.refetch = function(e) {
                this.data = {}, this.versions = [], this.mulilinkVersions = [], this.extVersions = [];
                var t = this.collector._config.get();
                t.user.user_unique_id = e.user_unique_id || t.user.user_unique_id, t.user.ssid = e.ssid || t.user.ssid, t.user.web_id = e.web_id || t.user.web_id, this.init(t)
            }, e.prototype.init = function(e, t) {
                if (!this.collector.destroyInstance)
                    if (this.domain) {
                        ...
                        var i = e.user,
                            n = e.header,
                            r = __rest(n, []);
                        this.user = __assign({}, i), this.header = __assign({}, n), this._fetch(__assign({}, r), {
                            success: t,
                            fail: t
                        })
                    } else console.warn("sorry, channel in is not support abtest yet~")
                ...
                if (t) {
                    var i = t.ab_version,
                        ...
                        s = this.checkFromUrl();
                    s ? this.mulilinkVersions.push(s) : this.mulilinkVersions = o || [], this.extVersions = r, i && i.length && (this.versions = i, this.data = n, setTimeout(function() {
                        e._configVersions()
                    }))
                }
                ...
                if (o) {
                    if ("object" == typeof o[i] && void 0 !== o[i].val) {
                        var s = o[i].vid;
                        return "$ab_url" === t ? (-1 === this.mulilinkVersions.indexOf(s) && this.mulilinkVersions.push(s), this._updateMultilinkVersions()) : (-1 === this.versions.indexOf(s) && this.versions.push(s), this._updateVersions()), this._abEvent(s, t, n), void r(o[i].val)
                    }
                    r(n)
                } else r(n)
                ...
                var n = this;
                try {
                    if (this.initConfig.disable_track_event) return;
                    var r = this.collector._config.get(),
                        o = r.header,
                        s = r.user,
                        a = getCache(this.appId);
                    if (a && a.uuid && a.uuid !== s.user_unique_id) return;
                    if (e) {
                        var c = {
                        ...
                        o.ab_sdk_version = "" + e, o.custom = JSON.stringify(o.custom);
                        var u = {
                            events: [c],
                            user: s,
                            header: o
            ...
            }, e.prototype._configVersions = function() {}, e.prototype._getABconfig = function(e, t) {
                var i = Object.keys(e);
                ...
                if (e && "[object Object]" == Object.prototype.toString.call(e)) {
                    setDataCache(this.appId, e, t), this.data = e;
                    var n = [];
                    ...
                    if (o && o.val && this.enable_ab_visual) {
                        ...
                        s && a && this.getVar("$ab_url", s, function(e) {
                            if (console.log(e), "heatmap" !== i.editMode) {
                                var t = window.location.href; - 1 !== t.indexOf("multilink=true") && (t = i.filterUrl(t)), s !== t ? setTimeout(function() {
                                    if (!i.collector.destroyInstance) {
                                        var e = "" + s; - 1 !== (e = -1 === e.indexOf("http") ? "https://" + e : e).indexOf("?") ? e += "&multilink=true" : e += "?multilink=true", parseURL(e).host !== location.host && (e = e + "&vid=" + a), window.location.href = e
                                    }
                                }, 50) : i.closeOverlayer()
                            }
                        })
                ...
                var c = "" + this.domain + API,
                    ...
                    h = !1; - 1 !== u.indexOf("multilink=true") && (u = this.filterUrl(u), h = !0);
                ...
                xhr(c, {
                    ...
                    i.fetchStatus = FetchStatus.Complete, i.refreshFetchStatus = RefreshFetchStatus.Complete;
                    var t = e.data;
                    "success" === e.message ? (i._fetchComplete(t, i.user.user_unique_id), o(t)) : (i._fetchComplete(null, i.user.user_unique_id), a())
                }, function() {
                    i.fetchStatus = FetchStatus.Complete, a(), i._fetchComplete(null, i.user.user_unique_id)
                }, "", this.timeout)
            }, e.prototype.filterUrl = function(e) {
                try {
                    var t = ""; - 1 !== e.indexOf("&multilink=true") ? t = "&multilink=true[\0-ÿ]*" : -1 !== e.indexOf("?multilink=true") && (t = "\\?multilink=true[\0-ÿ]*");
        ...
        Et_Test = function() {
            function e(e) {
                this.config = e, "string" == typeof e.event_verify_url ? this.url = e.event_verify_url + "/" + ET_TEST_URL : console.log("please use correct et_test url")
            }
        ...
        Plugin = function() {
            return function(e, t, i, n, r) {
                t && (t.enable_stay_duration && (this.stay = new StayDuration(n, t)), t.disable_session || (this.session = new Session$1(i)), t.channel_domain || t.disable_sdk_monitor || (this.monitor = new Monitor(t)), t.event_verify_url && (this.et_test = new Et_Test(t)), t.enable_ab_test && (this.ab = new AB(e, r, t)), t.max_storage_num && (this.maxStorage = maxStorage))
            }
        }(),
        Profile = function() {
            function e(e, t, i) {
                this.config = i, this.processEvent = e, this._event = t, this.cache = {}, this.duration = 6e4, this.profileReady = !1, this.config = i, this.reportUrl = (i.channel_domain || decodeUrl(LOG_URL[i.channel])) + "/profile/list"
            }
            return e.prototype.start = function() {
                ...
                if (e) {
                    var t = {};
                    for (var i in e) "string" == typeof e[i] || "Array" === Object.prototype.toString.call(e[i]).slice(8, -1) ? t[i] = e[i] : console.warn("please check the value of param: " + i + ", must be string or array !!!");
                ...
                try {
                    ...
                    var n = {};
                    for (var r in e) "string" == typeof e[r] || "number" == typeof e[r] || "Array" === Object.prototype.toString.call(e[r]).slice(8, -1) ? n[r] = e[r] : console.warn("please check the value of params:" + r + ", must be string,number,Array !!!");
                    var o = Object.keys(n);
                    if (!o.length) return;
                    var s = Date.now();
            ...
            e.exports = function() {
                ...
                var z = function() {
                        ...
                        return p.parse = function(e) {
                            ...
                            var h, d = w.p(o),
                                l = "set" + (this.$u ? "UTC" : ""),
                                f = (h = {}, h[r] = l + "Date", h[u] = l + "Date", h[s] = l + "Month", h[c] = l + "FullYear", h[n] = l + "Hours", h[i] = l + "Minutes", h[t] = l + "Seconds", h[e] = l + "Milliseconds", h)[d],
                                p = d === r ? this.$D + (a - this.$W) : a;
                            if (d === s || d === c) {
                                var _ = this.clone().set(u, 1);
                                _.$d[f](p), _.init(), this.$d = _.set(u, Math.min(this.$D, _.daysInMonth())).$d
                            } else f && this.$d[f](p);
                            ...
                            if (d === r) return l(1);
                            if (d === o) return l(7);
                            var f = (u = {}, u[i] = 6e4, u[n] = 36e5, u[t] = 1e3, u)[d] || 1,
                            ...
                            var d, l = w.p(u),
                                ...
                                _ = this - f,
                                g = w.m(this, f);
                            return g = (d = {}, d[c] = g / 12, d[s] = g, d[a] = g / 3, d[o] = (_ - p) / 6048e5, d[r] = (_ - p) / 864e5, d[n] = _ / 36e5, d[i] = _ / 6e4, d[t] = _ / 1e3, d)[l] || _, h ? g : w.a(g)
        ...
        duration = createCommonjsModule(function(e, t) {
            ...
            e.exports = (s = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, u = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, h = {
                years: a = 31536e6,
                months: c = 2592e6,
                days: o = 864e5,
                hours: r = 36e5,
                ...
                function e(e, t, i) {
                    var n = this;
                    if (this.$d = {}, this.$l = i, void 0 === e && (this.$ms = 0, this.parseFromMilliseconds()), t) return l(e * h[f(t)], this);
                ...
                return t.calMilliseconds = function() {
                    ...
                    var e = this.$ms;
                    this.$d.years = _(e / a), e %= a, this.$d.months = _(e / c), e %= c, this.$d.days = _(e / o), e %= o, this.$d.hours = _(e / r), e %= r, this.$d.minutes = _(e / 6e4), e %= 6e4, this.$d.seconds = _(e / 1e3), e %= 1e3, this.$d.milliseconds = e
                    ...
                    var t = this.$ms,
                        i = f(e);
                    return "milliseconds" === i ? t %= 1e3 : t = "weeks" === i ? _(t / h[i]) : this.$d[i], 0 === t ? 0 : t
                }, t.add = function(e, t, i) {
                    var n;
                    return n = t ? e * h[f(t)] : d(e) ? e.$ms : l(e, this).$ms, l(this.$ms + n * (i ? -1 : 1), this)
                ...
                i = r, n = r().$utils(), r.duration = function(e, t) {
                    var i = r.locale();
                    return l(e, {
                        $l: i
                    }, t)
                ...
                t.prototype.add = function(e, t) {
                    return d(e) && (e = e.asMilliseconds()), o.bind(this)(e, t)
                }, t.prototype.subtract = function(e, t) {
                    return d(e) && (e = e.asMilliseconds()), s.bind(this)(e, t)
                }
            })
        });
    ...
    var ignoreList = ["__cep_sdk_onboard", "__cep_trigger_sdk", "_be_active"],
        ...
        CepRule = function() {
            function CepRule(e, t, i) {
                this.support = !0, this.currentPlan = 1, this.shouldSendEvent = !1, this.staing = !1, this.test = !1, this.cepReady = !1, this.eventCache = [], this.storage = new Storage(!1), this.config = e;
                var n = e.channel_domain || decodeUrl(LOG_URL[e.channel || "cn"]);
                this.url = e.cep_url ? "" + e.cep_url : "" + n + CEP_URL, this.reportUrl = "" + n + REPORT_URL, this.key = "__tea_cep_plan_" + this.config.app_id, this.quotasKey = "__tea_cep_plan_quotas_" + this.config.app_id, this.configManager = t, this.hook = i, this.isWait = !1, this.eventCache = [], this.test = t.staging
            }
            return CepRule.prototype.init = function() {
                ...
                if (s && Object.keys(s).length && (o = !0, i = s.last_update_time, r = s.fetch_interval, n = s.config_version || 0, t = Date.now() - i > 1e3 * r), t) {
                    ...
                    xhr(this.url, {
                        ...
                        t && 0 === t.code ? (s.fetch_interval = t.fetch_interval, s.data = t.data, s.last_update_time = Date.now(), s.config_version = t.config_version, e.clearQuotas(), e.initState(t.data), e.storage.setItem(e.key, s), t.data.forEach(function(t) {
                            e.event("__cep_sdk_onboard", t.plan_id)
                        })) : 304 !== t.code && 400 !== t.code || !o ? console.log("code: " + t.code + ", request error，please try leater") : (console.log("code: " + t.code + ", use old rules~"), s.last_update_time = Date.now(), e.storage.setItem(e.key, s), e.initState(s.data))
                    }, function() {
                        o ? (e.planData = s.data, e.initState(s.data)) : (e.support = !1, console.log("request error，please try leater"))
                    })
                } else s.last_update_time = Date.now(), this.storage.setItem(this.key, s), console.log("rule still work, use cache"), this.initState(s.data)
            }, CepRule.prototype.initState = function(e) {
                var t = this;
                e && e.length && (this.stateArray = new Map, this.waitArray = new Map, this.planData = e, e.forEach(function(e) {
                    var i = new Map;
                ...
                if (this.support && (!this.staing || this.test) && e && e.length) try {
                    ...
                    for (var o = 0; o < r.length; o++) {
                        var s = r[o].event;
                        if (-1 !== ignoreList.indexOf(s)) return !1;
                            ...
                            for (var s = r.pattern.events, a = 0; a < s.length; a++) {
                                if (this.rule(e, t, i, s[a].condition)) {
                                    ...
                                    if (this.stateArray.get(o).singleRule) {
                                        this.changeStatus(o, s[a].id, i), this.publish([i], o, s[a].id);
                                        break
                                    }
                                    if (!u.isMatch) {
                ...
                r.isMatch = !0, r.event = i, r.matchTime = i.local_time_ms || Date.now(), n.patternState.set(t, r), this.stateArray.set(e, n)
                    ...
                    if (!r.get(t)) {
                        var o = setTimeout(function() {
                            var r = n.stateArray.get(e).patternState,
                                o = r.get(t);
                            if ("NOT_FOLLOWED_BY" === o.connection) !o.isMatch && r.get(o.after).isMatch || o.matchTime - r.get(o.after).matchTime > i.window ? ((s = n.waitArray.get(e).get(t)).triggerWait = !0, n.waitArray.set(e, n.waitArray.get(e).set(t, s)), n.publish([r.get(o.after).event], e, t)) : n.reset(e, t);
                            else if ("FOLLOWED_BY" === o.connection) {
                                var s;
                                if (o.isMatch && r.get(o.after).isMatch)(s = n.waitArray.get(e).get(t)).triggerWait = !0, n.waitArray.set(e, n.waitArray.get(e).set(t, s)), n.publish([r.get(o.after).event], e, t);
                                else n.reset(e, t)
                            }
                        }, i.window);
                        r.set(t, {
                ...
                try {
                    var o = i.event,
                        s = i.params;
                    if (s = JSON.parse(s), -1 !== moreOP.indexOf(n.op)) {
                        if (n.conditions && n.conditions.length) {
                            ...
                            ! function i(n, a) {
                                for (var h = 0; h < n.length; h++)
                                    if (c++, -1 !== moreOP.indexOf(n[h].op) && n[h].hasOwnProperty("conditions")) u.set(c, {
                                        op: n[h].op,
                                        result: void 0,
                                        fatherKey: a,
                                        resultList: [],
                            ...
                            for (var h = u.get(0); void 0 === h.result || h.resultList.length < h.resultLength;) u.forEach(function(e, t) {
                                if (void 0 !== e.result && void 0 !== e.fatherKey) {
                                    var i = u.get(e.fatherKey);
                                    i.resultList.length < i.resultLength && -1 === i.resultKey.indexOf(t) && (i.resultKey.push(t), i.resultList.push(e.result), u.set(e.fatherKey, i))
                                }
                            }), u.forEach(function(e) {
                                e.resultList && e.resultList.length === e.resultLength && ("and" === e.op && (e.result = -1 === e.resultList.indexOf(!1)), "or" === e.op && (e.result = -1 !== e.resultList.indexOf(!0)))
                            });
                ...
                try {
                    ...
                    this.hook.emit("__cep_match", r), (window.opener || window.parent).postMessage({
                        type: "__cep_match",
                        data: r
                    }, "*"), this.event("__cep_trigger_sdk", t), this.addQuotas(t), this.reset(t, i), console.log(this.stateArray)
                } catch (e) {
                    return void console.log(e.message)
                }
                ...
                if (t && t.length) {
                    ...
                    var n = i[e].value;
                    0 === n && (i[e].lastTime = Date.now()), i[e].value = n + 1, this.storage.setItem(this.quotasKey, i)
                }
                ...
                if (i[e] || (i[e] = {
                    ...
                    return "all" === o ? !(i[e].value >= r) || (console.log("plan:" + e + " limt"), !1) : Date.now() - i[e].lastTime >= o ? (i[e].value = 0, i[e].lastTime = Date.now(), this.storage.setItem(this.quotasKey, i), !0) : !(i[e].value >= r) || (console.log("plan:" + e + " limit"), !1)
                }
                return !0
                ...
                if (i.singleRule) {
                    ...
                    n.isMatch = !1, n.event = null, n.matchTime = 0, n.initTime = Date.now(), i.patternState.set(t, n)
                } else i.patternState.forEach(function(e) {
                    e.isMatch = !1, e.event = null, e.matchTime = 0, e.initTime = Date.now()
                });
                this.stateArray.set(e, i);
                var r = this.waitArray.get(e);
                r && r.get(t) && (clearTimeout(r.get(t).waitFn), r.delete(t))
                ...
                if (e.indexOf(".") > -1) {
                    var n = e.split(".");
                    t = n[0], e = n[1], "header" === t && "custom" === e && (e = n[2], i = n[1])
                }
                return {
                    scope: t,
                    key: e,
                ...
                try {
                    ...
                    if (-1 !== ["is not null", "is null"].indexOf(op)) return "is null" === op ? null == paramA : null != paramA;
    ...
    function getText(e) {
        ...
        return function e(t) {
            var n = getNodeText(t);
            if (n && -1 === i.indexOf(n) && i.push(n), t.childNodes.length > 0)
                for (var r = t.childNodes, o = 0; o < r.length; o++) 8 !== r[o].nodeType && e(r[o])
        }(t), i
    }
    ...
    function getTextSingle(e) {
        ...
        return function e(t) {
            var n = getNodeText(t);
            if (n && (i += n), t.childNodes.length > 0)
                for (var r = t.childNodes, o = 0; o < r.length; o++) 3 === r[o].nodeType && e(r[o])
        }(t), i
    }
    ...
    var hasAttribute = function(e, t) {
        ...
        getAttributes = function(e, t) {
            var i = {};
            if ("string" == typeof t) hasAttribute(e, t) && (i.attrs = e.getAttribute(t));
        ...
        isSVG = function(e) {
            ...
            for (var t = e.parentElement, i = !1; t;) "svg" === t.tagName.toLowerCase() ? (t = null, i = !0) : t = t.parentElement;
            return i
        };
    ...
    var Listener = function() {
            function e(e, t, i) {
                ...
                }, this.config = t.getConfig().eventConfig, this.options = e, this.beatTime = e.beat, this.statistics = !1, this.route = i
            }
    ...
    function getXpathIndex(e) {
        ...
        var t = 0,
            i = e.parentElement;
        if (i)
            for (var n = i.children, r = 0; r < n.length && n[r] !== e; r++) n[r].nodeName === e.nodeName && t++;
        return {
    ...
    function getElementData(e, t, i, n) {
        ...
        if (window.TEAVisualEditor.getOriginXpath && (v = window.TEAVisualEditor.getOriginXpath({
                xpath: l,
                positions: m
            })), r.element_path = v && v.xpath || l, r.positions = v && v.positions || m, n && !n.text && (r.texts = p, r.element_title = getTextSingle(t)), r.element_id = t.getAttribute("id") || "", r.element_class_name = t.getAttribute("class") || "", r.element_type = t.nodeType, r.element_width = Math.floor(a), r.element_height = Math.floor(c), r.touch_x = u, r.touch_y = h, r.page_manual_key = "", r.elememt_manual_key = "", r.since_page_start_ms = g, r.page_start_ms = _, r.page_path = location.pathname, r.page_host = location.host, i.track_attr && isAttrFilter(t, i.track_attr)) {
            var y = getAttributes(t, i.track_attr);
            for (var b in y) r[b] = y[b]
        }
        var w = getContainer(t);
        return "A" === w.tagName && (r.href = w.getAttribute("href")), "IMG" === t.tagName && (r.src = t.getAttribute("src")), r
    }
    ...
    var EventHandle = function() {
            ...
            return e.prototype.handleEvent = function(e, t) {
                ...
                e.event = this.eventName.page, e.page_total_width = window.innerWidth, e.page_total_height = window.innerHeight;
                try {
                ...
                try {
                    e.page_viewport_width = window.innerWidth, e.page_viewport_height = window.innerHeight, e.page_viewport_position = document.documentElement.scrollTop, e.page_total_width = document.documentElement.scrollWidth, e.page_total_height = document.documentElement.scrollHeight, e.scroll_width = document.documentElement.scrollLeft + window.innerWidth, e.scroll_height = document.documentElement.scrollTop + window.innerHeight, e.since_page_start_ms = Date.now() - window.performance.timing.navigationStart, e.page_start_ms = window.performance.timing.navigationStart
                } catch (e) {
    ...
    function loadEditorScript$1(e) {
        ...
        e.fromSession;
        isLoaded$1 || (isLoaded$1 = !0, loadScript(i, function() {
        ...
        if (addAllowdOrigin(["*"]), i) {
            ...
            try {
                ...
                if (s && s.length && (s.forEach(function(e) {
                    ...
                    }), o || document.currentScript && (o = document.currentScript.src), o && (r = o.split("/")) && r.length)) {
                    n = "https:/";
                    for (var a = 2; a < r.length && a !== r.length - 1; a++) n = n + "/" + r[a]
                }
            } catch (e) {}
        }
        if (init(t, SDK_VERSION), checkSession()) {
            ...
            receiveMsg("tea:openVisualEditor", function(t) {
                ...
                if (r) {
                    var o = r.referrer,
                        s = r.lang;
                    if (o ? (window.TEAVisualEditor.__editor_ajax_domain = o, EDITOR_URL = EDITOR_URL_NEW) : EDITOR_URL = EDITOR_URL_OLD, i) {
                        var a = r.version;
                        EDITOR_URL = n ? "" + n + (a ? "/visual-editor-rangers-v" + a : "/visual-editor-rangers-v1.0.0") + ".js" : EDITOR_URL_NEW, window.TEAVisualEditor.__editor_verison = a
                    }
                    window.TEAVisualEditor.__editor_url = EDITOR_URL, window.TEAVisualEditor.lang = s, loadEditorScript$1({
                        event: t,
    ...
    var defaultOpt = {
        ...
        AutoTrack = function() {
            ...
            return e.prototype.start = function(e, t, i, n, r) {
                i = Object.assign(defaultOpt, i), this.destroyed = !1, this.options = i, this.logFunc = t, this.logFuncBecon = n, this.Config = new Config(defaultConfig), this.Listener = new Listener(i, this.Config, r), this.EventHandle = new EventHandle(e, i), this.Request = new Request(this.logFunc, this.logFuncBecon), this.autoTrackStart = !0, this.init()
        ...
        exportAutoTrack = function(e, t, i, n) {
            ...
            if (!e.autotrack || !e.autotrack.collect_url || e.autotrack.collect_url()) {
                ...
                if (r) {
                    var s = {};
                    "object" == typeof r && (s = r), o.start(e, t, s, i, n), readyToLoadEditor$1(o, e)
                } else o.autoTrackStart && o.destroy();
                return null
            }
        },
        exportMethods = ["profileSet", "profileSetOnce", "profileIncrement", "profileUnset", "profileAppend", "getVar", "getAbSdkVersion", "onAbSdkVersionChange", "offAbSdkVersionChange", "getABconfig", "openOverlayer", "closeOverlayer", "getAllVars", "setExternalAbVersion", "getToken", "destroy"],
        Methods = __spread(["init", "config", "send", "start", "predefinePageView", "beconEvent", "on", "clearEventCache", "setNativeAppId", "resetStayDuration", "autoInitializationRangers", "setWebIDviaUnionID", "setWebIDviaOpenID", "filterEvent"], exportMethods),
        ...
        lastEventId, Collector = function() {
            function e(e) {
                ...
                this.is_first_time = !1, this.Native = !1, this.staging = !1, this.sdkload = !1, this._getToken = !1, this.predefinePageView = function(e) {
                    ...
                    if (!t.sdkload) return t.logger.warn("sdk init error, api can not call, getToken will return {}"), void e({});
                    var n = !1,
                        r = function() {
                            if (!n) {
                                n = !0;
                    ...
                    i && setTimeout(function() {
                        r()
                    }, i), t._token.isTokenReady() ? r() : (t.hook.on("get-token", function() {
                        r()
                    }), t._getToken = !0)
                }, this.name = e, this._isSend = !1, this.hook = new Hook, this.storage = new Storage(!1), this.plugin = {}
            }
            return e.prototype.autoInitializationRangers = function(e) {}, e.prototype.init = function(e) {
                ...
                this.sdkload ? this.Native && this.appBridge.bridgeInject() ? this.appBridge.hasStarted(function(i) {
                    if (i)
                        for (var n in e) "user_unique_id" === n ? t.appBridge.setUserUniqueId(e[n]) : e[n] ? t.appBridge.addHeaderInfo(n, e[n]) : t.appBridge.removeHeaderInfo(n);
                    else t._setConfig(e)
                ...
                if (this._inited)
                    if (e && "object" == typeof e) {
                        ...
                        if (this.configPersist) {
                            ...
                            i && (t = Object.assign(i, e)), this._config.setStore(e)
                        }
                        for (var n in t) "user_unique_id" !== n ? "web_id" !== n ? this._config.set(n, t[n]) : this._token._setWebid(t[n]) : this._token._setUuid(t[n])
                ...
                this.sdkload ? this.Native && this.appBridge.bridgeInject() ? this.appBridge.hasStarted(function(t) {
                    t ? (e.logger.info("jsbrige open, to native"), e.predefinePageView()) : e._start()
                ...
                if (this._token.isTokenReady()) {
                    ...
                    this._isSend = !0, this.logger.info("userInfo:" + JSON.stringify(this._config.get("user"))), this.logger.info("sdk is ready,version is " + SDK_VERSION + ". you can report now !!!"), this._event.setReady(), this.match && this.match.init(), this.autoPV && this.predefinePageView(), this._initConfig.spa && this.spaView.add("spa", this.predefinePageView), this._getToken && this.hook.emit("get-token"), this.hook.on("token-change", function(t) {
                    ...
                    this.profile = new Profile(this._processEvent.bind(this), this._event, this._initConfig), this.plugin && this.plugin.ab && this.plugin.ab.init(this._config.get())
                ...
                if (this.sdkload) {
                    var n = __read(t, 1)[0],
                        r = [];
                    "Array" !== Object.prototype.toString.call(n).slice(8, -1) ? r[0] = t : r = t, r = r.map(function(t) {
                ...
                e ? this._event.beconEvent(t) : this._event.event(t), this._session._updateSessionId(), this.plugin && this.plugin.session && this.plugin.session.process()
                ...
                try {
                    ...
                    var n, r = t;
                    return "object" != typeof r && (r = {}), r.profile ? delete r.profile : r.event_index = getIndex(), r.local_ms ? (n = r.local_ms, delete r.local_ms) : n = +new Date, {
                        event: i,
                        params: r,
                        local_time_ms: n,
    ...
    var CollectAsync = function(e) {
            ...
            return _defineProperty(this, "_exportCollect", function() {
                ...
                t._isProcess ? t._executeCmd.apply(t, i) : (t.cmdQueue.push(i), t._processCmd())
            }), _defineProperty(this, "_processCmd", function() {
                if (0 !== t.cmdQueue.length) {
                    var e, i, n, r, o;
                    i = t.cmdQueue, n = "init", r = "0", o = -1, i.forEach(function(e, t) {
                        (void 0 !== r ? e[r] : e) === n && (o = t)
                    }), -1 !== (e = o) && (t._isProcess = !0, t._executeCmd.apply(t, t.cmdQueue[e]), t.cmdQueue.forEach(function(i, n) {
            ...
            }), this.cmdQueue = [], this.name = e, this.colloctor = new Collector(e), this._isProcess = !1, this._alias = {}, this._processCmd(), Methods.forEach(function(e) {
        ...
        processCmdArray = function(e) {
            try {
                var t = __read(e),
                    i = t[0],
                    n = t.slice(1);
                if (!i) return void console.error("the eventName is: " + i + ", error, stop report, please check");
                var r = i.split(".");
                if (1 === r.length) getCmdArray("default").push(__spread([i], n));
                else if (2 === r.length) "event" === r[0] ? getCmdArray("default").push(__spread([i], n)) : getCmdArray(r[0]).push(__spread([r[1]], n));
                else {
                    var o = r[0],
                        s = [r[1], r[2]].join(".");
        ...
        transferAsync = function(e) {
            if ("undefined" != typeof window) {
                ...
                if (t && window[t]) {
                    var i = window[t];
                    i.init || (e.q = i.q || [], e.l = i.l || Date.now(), window[t] = e)
                }
            }
        },
    ...
    defaultClient.q = [], defaultClient.l = Date.now(), defaultClient._instanceMap = insMap, defaultClient._instanceCmdMap = CmdMap, Methods.forEach(function(e) {
        defaultClient[e] = defaultClient.bind(null, e)
    }), transferAsync(defaultClient), processCmd();
    var Collector$1 = CollectAsync;
    return exports.Collector = Collector$1, exports.default = defaultClient, exports
}({});